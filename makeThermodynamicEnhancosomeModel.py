...
parser.add_argument('-drop',dest='dropoutTFTF',	metavar='<dropoutTFTFProb>',help='Dropout percent for TFTF interactions (good values are ~0.5 [default=no dropout]', required=False);
